...
/// Events screen showing community events and meetups.
  ...
  void _toggleSearch() {
    setState(() {
      ...
      if (!_isSearching) {
        ...
        ref.read(eventsProvider.notifier).search(null);
      }
    });
  }

  void _onSearch(String query) {
    ref.read(eventsProvider.notifier).search(query);
  }
                  ...
                  itemBuilder: (context, index) {
                    if (index == 0) {
                      ...
                      return FilterChip(
                        ...
                        onSelected: (_) {
                          ref.read(eventsProvider.notifier).filterByType(null);
                        },
                      );
                    }
                    ...
                    return FilterChip(
                      ...
                      onSelected: (_) {
                        ref.read(eventsProvider.notifier).filterByType(type);
                      },
                    );
                  },
                ),
